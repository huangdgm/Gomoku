...
public class Judge {
	...
	/**
	 * All the information the judge should know to control the game is the
	 * distribution of current chess points.
	 */
	 ...
	 * 
	 * @param chessPoint
	 *            The current chess point to be checked.
	...
	private boolean isWinnerAfterTheCurrentChessPoint(ChessPoint chessPoint) {
		...
		// The initial value for the total number of chess points to be counted
		// in a line should be one, since there is at least one chess point to
		// be counted.
		...
		// The initial value for the total number of chess points to be counted
		// to a specific direction should be zero, since there is zero or more
		// chess points to be counted in that direction.
		...
		// Count the number of chess points in a line based on the
		...
		for (Direction direction : Direction.values()) {
			...
			// Count the number of chess points in the northeast and the
			// southwest direction.
			...
			// Count the number of chess points in the southeast and the
			// northwest direction.
	 ...
	 * 
	 * @param chessPoint
	 *            The current chess point.
	 * @param direction
	 *            The direction to which the number of continuous chess points
	 *            will be counted.
	 ...
	 * 
	 * @param x
	 *            The x position of the chess point.
	 * @param y
	 *            The y position of the chess point.
